...
namespace MondayOFF {
    public static class EventTracker {
        ...
        public static void TryStage(int stageNum, string stageName = "Stage") {
            ...
            Debug.Log($"[EVERYDAY] Editor Event Tracker: Trying {stageName} {stageNum}");
        }
        ...
        public static void ClearStage(int stageNum, string stageName = "Stage") {
            ...
            Debug.Log($"[EVERYDAY] Editor Event Tracker: Cleared {stageName} {stageNum}");
        }
        ...
        public static void LogCustomEvent(string eventName, Dictionary<string, string> parameters = null) {
            ...
            if (parameters == null) {
                Debug.Log($"[EVERYDAY] Editor Event Tracker: {eventName} logged without any parameters");
            } else {
                string paramString = "\n";
                ...
                Debug.Log($"[EVERYDAY] Editor Event Tracker: {eventName} logged with parameters: {paramString}");
            }
        }

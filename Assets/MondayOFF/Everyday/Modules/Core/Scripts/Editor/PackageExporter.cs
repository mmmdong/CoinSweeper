...
namespace MondayOFF {
    public class PackageExporter {
        ...
        public static void ExplortEverydayPackage() {
            ...
            File.Copy(Path.Combine(projectPath, "ReadMe.md"), "Assets/MondayOFF/ReadMe.md", true);
            File.Copy(Path.Combine(projectPath, "Changelog.md"), "Assets/MondayOFF/Changelog.md", true);
        ...
        public static void ExplortEverydayPackageForPublishing() {
            var exportPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), $"Builds/Everyday_Pub_{EveryDay.Version}.unitypackage");

            if (!EditorUtility.DisplayDialog("Export Path", $"{exportPath}", "Ok", "Cancel")) {
                return;
            }

            File.Delete("Assets/MondayOFF/ReadMe.md");
            File.Delete("Assets/MondayOFF/Changelog.md");
...
// What else...
        ...
        private static void CleanUpSetttings() {
            ...
            if (assets == null || assets.Length <= 0) {
                Debug.Log("[EVERYDAY] NOT found, search all");
            ...
            Debug.Assert(settings != null, "[EVERYDAY] NO SETTINGS FOUND");
